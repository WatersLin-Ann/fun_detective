  ...
  const evidence = [
    {
      ...
      keyInfo: "死者并非被刺杀，而是毒杀。面部表情显示他死前经历了极大的痛苦和恐惧。",
      icon: "💀"
    },
    {
      id: "blood-word",
      ...
      keyInfo: '"RACHE"是德语，意思是"复仇"。这不是人名，而是凶手留下的宣言。',
      icon: "🩸"
    },
    {
      id: "ring",
      ...
      keyInfo: "死者是男性，这枚女式戒指不可能属于他。这是凶手故意留下的，用来引诱某人出现。",
      icon: "💍"
    },
    {
      id: "footprints",
      ...
      keyInfo: "两种脚印说明现场至少有两个人。大靴子是凶手的，小靴子可能是死者的。",
      icon: "👣"
    },
    {
      id: "cigar-ash",
      ...
      keyInfo: "死者不抽雪茄，这些烟灰属于凶手。凶手抽印度雪茄，说明他有一定经济实力。",
      icon: "🚬"
    },
    {
      id: "carriage-tracks",
      ...
      keyInfo: "私人马车说明凶手有自己的马车，或者就是马车夫本人。车轮印的方向显示马车是从东边来的。",
      icon: "🛞"
    }
  ];
